...
const prizes: Prize[] = [
    {
        ...
        title: "Silver Prize",
        amount: "TBD",
        image: "/Sparkhack/silver prize.png",
    ...
    },
    {
        ...
        title: "Gold Prize",
        amount: "TBD",
        image: "/Sparkhack/gold prize.png",
    ...
    },
    {
        ...
        title: "Bronze Prize",
        amount: "TBD",
        image: "/Sparkhack/bronze prize.png",
    ...
    return (
        <section id='prizes' className="relative w-full py-24 flex flex-col items-center justify-center bg-transparent z-10">
            ...
            <div className='maxWidthForSections w-full flex flex-col items-center px-4'>
                ...
                >
                    {/* Changed heading text to slate-800 to contrast with the light blue background */}
                    ...
                    {prizes.map((prize) => {
                        ...
                        return (
                            <motion.div
                                ...
                                /* Darkened the background to bg-slate-900/80 for much better visibility of text */
                                className={`group relative flex flex-col items-center flex-1 max-w-[280px] p-2 sm:p-4 md:p-8 rounded-xl md:rounded-3xl 
                  bg-slate-900/80 hover:bg-slate-900/90
                  ...
                  ${prize.borderGlow} ${prize.glow}`}
                            >
                                ...
                                <div className="mt-8 md:mt-10 flex flex-col items-center justify-end h-full text-center w-full">
                                    <h3 className="font-rajdhani text-[11px] leading-tight sm:text-base md:text-xl lg:text-2xl font-bold text-white tracking-wide mb-1 md:mb-2 group-hover:text-fuchsia-300 transition-colors">
                                        {prize.title}
                                    </h3>

                                    {/* Amount Pill */}
                                    <div className="px-2 py-1 md:px-6 md:py-2 rounded-full bg-black/50 border border-white/10 mt-auto md:mt-2">
                                        <p className="font-orbitron text-[10px] sm:text-sm md:text-lg lg:text-xl font-bold text-cyan-400 tracking-wider">
                                            {prize.amount}
                                        </p>
                                    </div>
                                </div>
