...
const Data = [
    ...
    },
    {
        ...
        answer:
            "The deadline for registering for SparkHack is on 19th March, 12:00AM while that for the submissions is open till 19th March, 11:59pm .",
    },
];
    ...
    return (
        <section id="faq" className="relative w-full py-20 overflow-hidden transform-gpu">
            ...
            <div className="flex flex-col items-center justify-center gap-8 w-full relative z-10">
                <div className="maxWidthForSections w-full max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto flex flex-col justify-center">
                    ...
                    <div className="text-center mb-12 space-y-4 flex flex-col items-center">
                        <div className="relative inline-block">
                            {/* Darkened the heading to slate-800 to contrast with the light background */}
                            <h1 className="uppercase font-orbitron font-bold text-center text-2xl md:text-4xl mb-10 drop-shadow-md tracking-wide text-transparent bg-clip-text bg-gradient-to-b from-slate-800 to-slate-600">
                    ...
                    <div className="w-full flex flex-col items-center gap-4">
                        {Data.map((data, index) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Changed backgrounds to dark slate to ensure white text is highly readable */}
                                    <div className={`
                                        relative w-full overflow-hidden 
                                        border-l-[3px] backdrop-blur-md
                                        transition-all duration-300 ease-in-out
                                        ${isOpen
                                            ? 'bg-slate-900/90 border-cyan-400 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]'
                                            : 'bg-slate-900/60 border-white/10 hover:border-cyan-500/50 hover:bg-slate-900/80'}
                                    `}>
                                        ...
                                        <div className="flex items-center justify-between p-5 relative z-10">
                                            <div className="flex items-center gap-4 md:gap-6 flex-1">
                                                ...
                                                <div className={`
                                                    ...
                                                    border bg-slate-800/80 skew-x-[-10deg]
                                                    transition-colors duration-300
                                                    ${isOpen ? 'border-cyan-500 text-cyan-400' : 'border-white/10 text-gray-300 group-hover:border-cyan-400/70 group-hover:text-cyan-200'}
                                                `}>
                                            ...
                                            <div className={`
                                                ...
                                                ${isOpen ? 'border-cyan-400 bg-cyan-950/50 rotate-45' : 'border-white/20 group-hover:border-cyan-500/50 rotate-0'}
                                            `}>
                                                <div className={`text-sm transition-colors duration-300 ${isOpen ? 'text-cyan-400' : 'text-gray-400 group-hover:text-cyan-300'}`}>
                                                    <FaPlus />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        `}>
                                            <div className="overflow-hidden">
                                                <div className="px-5 pb-6 pl-[4.5rem] md:pl-[5.5rem] relative">
                                                    ...
                                                    <p className="font-rajdhani text-gray-300 sm:text-sm md:text-base text-sm leading-relaxed font-medium">
                                                        {data.answer}
                                                    </p>
                                                </div>
                                            </div>
                ...
                {/* Footer Note - Darkened for contrast */}
                <div className="mt-4 px-4 py-3 bg-slate-900/80 backdrop-blur-md rounded-full border border-cyan-500/30 mx-4 max-w-3xl text-center shadow-lg">
                    <span className="text-white/90 text-sm sm:text-base font-semibold font-rajdhani tracking-wide">
