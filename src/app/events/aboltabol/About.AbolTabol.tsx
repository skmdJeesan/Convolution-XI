...
export default function About() {
  ...
  const RegisterBtn = () => {
    if (!session) {
      return (
        <TransitionLink
          href="/login"
          className="shadow-white/50 hover:shadow-white/30  bg-[#0212B4] hover:bg-white   group flex items-center gap-2 px-5 py-3 
    ...
    return (
      <TransitionLink
        ...
        className="shadow-white/50 hover:shadow-white/30  bg-[#0212B4] hover:bg-white   group flex items-center gap-2 px-5 py-3 backdrop-blur-md rounded-full transition-all duration-300 shadow-sm cursor-pointer overflow-hidden"
      >
        <span className="font-orbitron text-sm md:text-base font-bold group-hover:text-[#0212B4] text-[#ffff] uppercase tracking-wide">
  ...
  return (
    <section
      id="about"
      className="relative w-full max-h-screen flex items-center justify-center pt-20 px-6 pb-10  overflow-hidden "
    >
      <div
