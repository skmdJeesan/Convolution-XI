        ...
        <div id='contact' className='relative flex flex-col pt-5 overflow-hidden z-0'>
                ...
                <div className="flex flex-col md:grid md:grid-cols-3 gap-8 mt-4 w-full">
                    ...
                    <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            <p className="font-orbitron text-blue-400 font-semibold text-base uppercase tracking-wide">
                    ...
                    <div className='flex flex-col items-center w-full '>
                        ...
                        <div className='flex flex-col items-center sm:items-start md:items-center md:ml-7 lg-ml-2 lg:items-start'>
                            ...
                            <ul className="flex flex-col gap-4">
                                ...
                                {/* Address */}
                                <li className='flex items-start gap-4 group'>
                                    <Link target="_blank" href="https://maps.app.goo.gl/wKYjjoLyR1ScsFEq5" className="flex items-center justify-center w-10 h-10 rounded-lg  bg-white/5 border border-white/10 group-hover:border-blue-400 group-hover:bg-blue-400/10 group-hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] transition-all duration-300 shrink-0">
                                        <MdLocationOn className="text-xl text-blue-400 mt-0.5 group-hover:text-blue-300 transition-colors duration-300" />
                                    </Link>
                                    <div className="text-md">
                                        <span className="font-rajdhani text-slate-400 font-bold block mb-0.5 group-hover:text-blue-400 transition-colors duration-300">Address</span>
                                        <Link
                                ...
                                {/* Phone */}
                                <li className='flex items-start gap-4 group'>
                                    <a href="tel:+918240961456" className="flex items-center justify-center w-10 h-10 rounded-lg  bg-white/5 border border-white/10 group-hover:border-blue-400 group-hover:bg-blue-400/10 group-hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] transition-all duration-300 shrink-0">
                                    ...
                                    <div className="text-md">
                                        ...
                                        <a href="tel:+918240961456" className="font-semibold font-rajdhani block text-slate-200 hover:text-white transition-colors">
                                            +91 8240961456
                                        </a>
                                        <a href="tel:+917044484274" className="font-semibold font-rajdhani block text-slate-200 hover:text-white transition-colors">
                                            +91 70444 84274
                                        </a>
                                        <a href="tel:+918900002887" className="font-semibold font-rajdhani text-slate-200 hover:text-white transition-colors  block">
                                            +91 89000 02887
                                        </a>
                                    </div>
                                </li>
                                ...
                                {events.map((event, index) => (
                                    <li key={index}>
                                        <TransitionLink href={event.href} className="group flex items-center justify-between border-b border-transparent hover:border-white/10 pb-0.5 transition-colors gap-x-1" >
                                            <span className="font-rajdhani text-base font-semibold md:text-lg text-slate-300 group-hover:text-blue-400 transition-colors">
                                                <FlipLink>{event.name}</FlipLink>
                                            </span>
                                            <span className="hidden md:block text-blue-400 text-lg opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-out">
                                                →
                                            </span>
                                        </TransitionLink>
                                    </li>
            ...
            <div className='middle relative w-full -mt-13 md:-mt-30  h-[25vw] md:h-[22vw] overflow-clip z-10 pointer-events-none flex items-end justify-center'>
                ...
                <h1
                    ...
                    className='font-orbitron text-[13vw] md:text-[12vw] lg:text-[14vw] [&_span]:text-transparent [&_span]:bg-clip-text [&_span]:bg-linear-to-b [&_span]:from-[#f2f2ef] [&_span]:to-black/50 tracking-tighter font-bold absolute -bottom-3 md:-bottom-9 lg:-bottom-12 leading-none whitespace-nowrap'
                >
                    {text}
                </h1>
            ...
            <div className='relative w-full bg-transparent/40 backdrop-blur-md z-30'>
                <div className="w-[95%] h-px bg-linear-to-r from-transparent via-blue-500/80 to-transparent mx-auto"></div>
