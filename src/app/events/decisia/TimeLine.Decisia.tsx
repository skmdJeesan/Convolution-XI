    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-between w-full px-4 gap-20">
       <motion.div
        ...
        <span className="font-orbitron text-2xl md:text-4xl font-bold tracking-widest text-yellow-400 drop-shadow-[0_0_15px_rgba(250,204,21,0.3)] uppercase text-center mt-2">
          Coming Soon...
        </span>
      </div>
