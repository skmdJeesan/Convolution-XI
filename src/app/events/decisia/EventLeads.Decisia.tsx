  ...
  return (
    <div id='team' className="team-section">
      ...
      <div className='maxWidthForSections relative z-10'>
        ...
        >
          <h1 className="font-orbitron font-bold text-center text-3xl sm:text-4xl tracking-wide text-transparent bg-clip-text bg-gradient-to-b from-gray-300 to-white drop-shadow-[0_0_15px_rgba(255,255,255,0.15)] whitespace-nowrap uppercase">
            Our Team
