                    ...
                    <div className='flex flex-col items-center w-full '>
                        ...
                        <div className='flex flex-col items-center sm:items-start md:items-center md:ml-7 lg-ml-2 lg:items-start'>
                            ...
                            <ul className="flex flex-col gap-4">
                                ...
                                {/* Phone */}
                                <li className='flex items-start gap-4 group'>
                                    <a href="tel:+918617750367" className="flex items-center justify-center w-10 h-10 rounded-lg  bg-white/5 border border-white/10 group-hover:border-blue-400 group-hover:bg-blue-400/10 group-hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] transition-all duration-300 shrink-0">
                                    ...
                                    <div className="text-md">
                                        ...
                                        <a href="tel:+918617750367" className="font-semibold font-rajdhani block text-slate-200 hover:text-white transition-colors">
                                            +91 86177 50367
                                        </a>
                                        <a href="tel:+919123646812" className="font-semibold font-rajdhani text-slate-200 hover:text-white transition-colors  block">
                                            +91 91236 46812
                                        </a>
                                    </div>
                                </li>
