...
export default function About() {
 ...
 const userEvents = contextData?.user?.eventsRegistered || [];
  ...
  return (
    <section
      id="about"
      className="relative w-full h-screen flex items-center justify-center bg-linear-to-b from-[#c4d79f] via-[#b1c880] to-[#83a252] pt-20  px-6 pb-10 overflow-hidden"
    >
      <div 
