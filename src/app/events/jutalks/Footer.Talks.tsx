                    ...
                    <div className='flex flex-col items-center w-full '>
                        ...
                        <div className='flex flex-col items-center sm:items-start md:items-center md:ml-7 lg-ml-2 lg:items-start'>
                            ...
                            <ul className="flex flex-col gap-4">
                                ...
                                {/* Phone */}
                                <li className='flex items-start gap-4 group'>
                                    <a href="tel:+919679640227" className="flex items-center justify-center w-10 h-10 rounded-lg  bg-white/5 border border-white/10 group-hover:border-fuchsia-300 group-hover:bg-fuchsia-300/10 group-hover:shadow-[0_0_15px_rgba(240,171,252,0.4)] transition-all duration-300 shrink-0">
                                    ...
                                    <div className="text-md">
                                        ...
                                        <a href="tel:+919679640227" className="font-semibold font-rajdhani block text-white hover:text-gray-200 transition-colors">
                                            +91 96796 40227
                                        </a>
                                        <a href="tel:+917908193370" className="font-semibold font-rajdhani text-white hover:text-gray-200 transition-colors  block">
                                            +91 79081 93370
                                        </a>
                                    </div>
                                </li>
