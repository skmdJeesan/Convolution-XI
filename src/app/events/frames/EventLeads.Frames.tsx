    ...
    <div id='team' className="team-section">
      ...
      <div className='maxWidthForSections w-full relative z-10'>
        ...
        >
          ...
          <p className="opacity-90 font-rajdhani text-center text-white text-shadow-dark mt-5 text-base sm:text-lg font-medium">Meet the event leads of 24 Frames! We are ready to address all your queries.</p>
        </motion.div>
