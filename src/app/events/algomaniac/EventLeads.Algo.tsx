...
const teamMembers: TeamMember[] = [
  {
    name: "Sohel Mondal",
    post: "Event Lead",
    image: "/peoplePics/Sohel.JPG",
    linkedin: "https://www.linkedin.com/in/sohel-mondal/",
    instagram: "https://www.instagram.com/clouds_470/",
    facebook: "",
  },
  {
    name: "Pritish Mahato",
    post: "Event Lead",
    image: "/peoplePics/Pritish.jpeg",
    linkedin: "https://www.linkedin.com/in/pritish-mahato-a9956827a",
    instagram: "https://www.instagram.com/pr1ti5h?igsh=eXhoNHFiZGJwbXU2",
    facebook: "",
  },
];
      ...
      <div className='maxWidthForSections relative z-10'>
        ...
        >
          ...
          <p className="opacity-90 font-rajdhani text-center text-white text-shadow-dark mt-5 text-base sm:text-lg font-medium">
            Meet the event leads of Algomaniac! We are ready to address all your queries.
          </p>
        </motion.div>
