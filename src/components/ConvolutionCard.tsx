...
const ConvolutionCard = ({ data }: ConvolutionCardProps) => {
  ...
  return (
    ...
    <div className="relative group w-full h-full perspective-1000">
      ...
      <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 via-red-600 to-yellow-600 rounded-[2rem] md:rounded-[2.5rem] blur-xl opacity-30 md:opacity-20 md:group-hover:opacity-50 transition duration-1000 md:group-hover:duration-500 animate-tilt" />
      
      {/* 2. THE MAIN CARD CHASSIS */}
      {/* NUCLEAR FIX: bg-[#080808] is solid opaque. No transparency here. 
          This acts as the light blocker. */}
      <div className="relative w-full h-full bg-[#080808] border border-white/10 md:group-hover:border-orange-500/50 rounded-[1.5rem] md:rounded-[2rem] overflow-hidden flex flex-col md:flex-row transition-all duration-500 shadow-2xl">
        ...
        <div className="relative w-full h-60 md:h-auto md:w-[45%] overflow-hidden z-20">
          ...
          {/* Fade Gradients */}
          <div className="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-r from-transparent via-[#080808]/60 to-[#080808] z-20" />
          ...
          <div className="absolute top-4 left-4 md:top-6 md:left-6 z-30">
            <div className="px-3 py-1.5 md:px-4 md:py-2 bg-black/70 backdrop-blur-md border border-orange-500/30 rounded-full flex items-center gap-2 md:gap-3 shadow-lg">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-orange-500"></span>
                </span>
                <span className="text-orange-50 font-bold text-[10px] md:text-[11px] tracking-[0.2em] uppercase">
                  {data.category}
                </span>
            </div>
          </div>
        ...
        */}
        <div className="relative w-full md:w-[calc(55%+8px)] md:-ml-2 flex flex-col justify-center overflow-hidden z-10 bg-[#080808]">
          ...
          <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-orange-900/20 rounded-full blur-[80px] pointer-events-none" />
          <div className="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-tl from-[#1a0500] via-[#080808] to-transparent pointer-events-none z-0" />
          ...
          <div className="relative z-10 p-6 md:p-12 md:pl-14 flex flex-col justify-center h-full">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-black uppercase text-white tracking-tighter leading-[0.9] drop-shadow-xl mb-3 md:mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-100 to-stone-400 md:group-hover:from-orange-400 md:group-hover:via-red-400 md:group-hover:to-yellow-400 transition-all duration-500">
                  {data.title}
                </span>
              </h2>

              {/* Decorative Line */}
              <div className="w-12 h-1 bg-orange-600 rounded-full mb-4 md:mb-6 md:group-hover:w-24 transition-all duration-500" />
