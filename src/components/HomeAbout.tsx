            ...
            <StatCard
              ...
              value={
                <span className="flex items-center">
                  <AnimatedCounter from={0} to={userCount + 199} delay={1.2} />
        ...
        >
          ...
          >
            <div className="relative w-full h-full overflow-hidden [mask-image:radial-gradient(ellipse_at_center,black_40%,transparent_100%)]">
              ...
              />
              <div className="absolute inset-0 bg-linear-to-tr from-cyan-500/10 via-transparent to-fuchsia-500/10 mix-blend-overlay"></div>
